...
sqlsrch = "select * from Hyper_Cars where Car_Name=" & "'" & searchvar & "'"
rs.Close
...
Form4.Text6.Text = rs.Fields("Manufacturing_Country")
...
Form4.Text12.Text = rs.Fields("Transmission")
